...
export const metadata: Metadata = {
  title: "Categoria no encontrada - Business Concept",
  description:
    "Lo sentimos mucho, pero la categoria que buscas no se encuentra en nuestra tienda. ¡Regresa al inicio!",
  keywords: "categoria, no encontrado, no existe, no se encuentra",
